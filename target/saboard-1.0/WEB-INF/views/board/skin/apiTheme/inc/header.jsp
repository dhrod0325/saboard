...
<!-- css -->
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/common/lib/clEditor/jquery.cleditor.css" />
...
<script type="text/javascript" src="<%=request.getContextPath() %>/resources/common/lib/clEditor/jquery.cleditor.min.js"></script>
