...
public class TestBoard {
	...
	public void selectBoardReplyList(){
		List<BoardReplyDomain> boardReplyListDomain = boardService.getAllBoardReplyListById(89);
	...
	public void getTotBoardCount() {
		assertNotNull("board count = " + boardService.getTotBoardCount(), boardService.getTotBoardCount());
	}
}