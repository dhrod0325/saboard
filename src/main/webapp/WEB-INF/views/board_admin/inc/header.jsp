...
<script type="text/javascript" src="<%=request.getContextPath() %>/resources/common/bootstrap/js/bootstrap.min.js"></script>

</head>
<body>
<div class="container-fluid">
	<h1><a href="<%=request.getContextPath() %>/admin/">SABOARD ADMIN PANEL</a></h1>
	<hr />
	<div class="row-fluid">